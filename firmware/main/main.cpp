...
extern "C" void app_main(void) {
    ...
    // 2. Mount LittleFS and load catalog
    init_fs();
    ...
    // 6. MQTT Client Setup (ponytail: initialized when network configured)
    esp_mqtt_client_config_t mqtt_cfg = {};
    #if defined(CONFIG_CAN_DO_MQTT_URI)
    mqtt_cfg.broker.address.uri = CONFIG_CAN_DO_MQTT_URI;
